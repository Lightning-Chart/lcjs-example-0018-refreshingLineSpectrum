# lcjs-example-0018-refreshingLineSpectrum
...
```
cd existing_repo
git remote add origin https://gitlab.com/arction/lcjs/lcjs-examples/lcjs-example-0018-refreshinglinespectrum.git
git branch -M master
